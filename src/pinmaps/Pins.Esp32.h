...
#pragma once
  ...
  #define ST4_W_PIN            16  // ST4 (OnStep) RA- West,  send data to OnStep
  #define ST4_S_PIN            4  // ST4 (OnStep) DE- South, clock input to ISR
  #define ST4_N_PIN            0  // ST4 (OnStep) DE+ North, recv data from OnStep
  #define ST4_E_PIN            2  // ST4 (OnStep) RA+ East,  always 12.5 Hz square wave on this pin

  #if ST4_AUX_INTERFACE == ON
    #define ST4_AUX_W_PIN      19  // ST4 (Aux) RA- West
    #define ST4_AUX_S_PIN      18  // ST4 (Aux) DE- South
    #define ST4_AUX_N_PIN      12  // ST4 (Aux) DE+ North
    #define ST4_AUX_E_PIN      13   // ST4 (Aux) RA+ East
  #endif

  #define UTILITY_LIGHT_PIN    14  // GPIO13 used as PWM output to drive utility lamp LED

  #define DISPLAY_RESET_PIN    23  // GPIO16 used to reset some displays, i.e. the SSD1309
